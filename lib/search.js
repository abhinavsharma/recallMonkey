...
Search.prototype.queryTable = function(tokens, preferredHosts, excludedHosts, 
  ...
  for (let i = 0; i < tokens.length; i++) {
    ...
    wordParams["tagleft" + i]  = '%,' + token + '%';
    wordParams["tagright" + i] = '%' + token + ',%';
    ...
    wordSelections.push("(tags LIKE :tagleft"  + i + ") OR" + 
                        "(tags LIKE :tagright" + i + ") OR" + 
                        "(CASE LOWER(tags) " + 
                          "WHEN :word" + i + " THEN 1 ELSE 0 END) as tag_" + i);
