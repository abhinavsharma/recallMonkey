...
Search.prototype.queryTable = function(words, preferredHosts, excludedHosts, timeRange, limit, skip) {
  let me = this;
  ...
  return utils.spinQuery(Places.PlacesUtils.history.DBConnection, {
    ...
    "params": wordParams,
    "query" : query,
  }).map(function ({id, title, url, frecency, rev_host, visit_count, last_visit_date}) {
    return {
      "title" : title,
      "url" : url,
      "revHost": rev_host ,
